  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <h3 className="text-xl font-semibold text-gray-800 mb-3">A Peaceful Sanctuary by the Lagoon</h3>
        ...
        <a
          href="#"
          className="inline-block bg-gray-900 text-white px-7 py-3 rounded-full font-medium shadow hover:bg-gray-800 transition"
        >
          Learn More
        </a>
      </div>
