  ...
  return (
    <section className="max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 py-10 xs:py-14 sm:py-20">
      <div className="mb-8 xs:mb-10 text-center">
        ...
        <h2 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-2 leading-tight">Start Your Adventure</h2>
        <h3 className="text-lg xs:text-xl sm:text-2xl font-light text-blue-700 mb-3 xs:mb-4">Book with Ease</h3>
        <p className="text-gray-700 max-w-xs xs:max-w-md sm:max-w-2xl mx-auto mb-6 xs:mb-8 text-base sm:text-lg">Reserve your spot for our exclusive experiences and activities. Simple booking process, unforgettable memories.</p>
      </div>
      {/* Steps */}
      ...
      <div className="relative rounded-2xl overflow-hidden shadow-lg mb-6 h-[180px] xs:h-[240px] sm:h-[320px]">
        ...
        <div className="relative z-20 p-5 xs:p-10 md:p-16 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 xs:gap-6 h-full">
          <div>
            <h3 className="text-white text-lg xs:text-2xl md:text-3xl font-bold mb-1 xs:mb-2">Ready for Your Next<br />Adventure?</h3>
            <p className="text-gray-100 text-xs xs:text-base mb-2 xs:mb-4 max-w-xl">Book your experience now and create memories that will last a lifetime. Our team is ready to help you plan the perfect activity.</p>
