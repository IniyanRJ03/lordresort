  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-20">
      <div className="mb-10 text-center">
        ...
        <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-2 leading-tight">Start Your Adventure</h2>
        <h3 className="text-2xl font-light text-blue-700 mb-4">Book with Ease</h3>
        <p className="text-gray-700 max-w-2xl mx-auto mb-8">Reserve your spot for our exclusive experiences and activities. Simple booking process, unforgettable memories.</p>
      </div>
      {/* Steps */}
      ...
      <div className="relative rounded-2xl overflow-hidden shadow-lg mb-6">
        ...
        <div className="relative z-20 p-10 md:p-16 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
            <h3 className="text-white text-2xl md:text-3xl font-bold mb-2">Ready for Your Next<br />Adventure?</h3>
            <p className="text-gray-100 text-base mb-4 max-w-xl">Book your experience now and create memories that will last a lifetime. Our team is ready to help you plan the perfect activity.</p>
