...
export default function FindUs() {
  return (
    <section className="max-w-5xl mx-auto px-4 py-20">
      ...
      <div className="flex flex-col md:flex-row gap-8 xs:gap-10 items-start">
        {/* Map */}
        <div className="rounded-2xl overflow-hidden shadow-lg w-full md:w-2/3 h-60 xs:h-80 md:h-96">
          <iframe
        ...
        <div className="flex-1 flex flex-col gap-6">
          <div className="bg-white rounded-2xl shadow p-4 xs:p-6 flex flex-col gap-4">
            <div className="flex items-start gap-3">
              <FaMapMarkerAlt className="text-blue-600 text-xl mt-1" />
              <div>
                <div className="font-semibold text-gray-900">Our Location</div>
                <div className="text-gray-700 text-xs xs:text-sm">Lord of beach resort. Yoga meditation Centre<br />36 School Rd, Batticaloa 30000</div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-gray-700 text-xs xs:text-sm">1234567890</div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-gray-700 text-xs xs:text-sm">lordresort@gmail.com</div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-gray-700 text-xs xs:text-sm">Reception: 24/7<br />Restaurant: 6:30 AM - 10:30 PM</div>
              </div>
            </div>
          </div>
          <div className="bg-white rounded-2xl shadow p-4 xs:p-6 mt-2">
            <div className="font-semibold text-gray-900 mb-1">Getting Here</div>
            <div className="text-gray-700 text-xs xs:text-sm">We're located in Batticaloa. From the Kovil in Navalady, head north for about 500 meters. Look for our distinctive entrance on the right side, marked by our resort sign. Free parking is available for all guests.</div>
          </div>
        </div>
      </div>
    </section>
